...
def connectar(device,command):
    net_connect = ConnectHandler(**device) # envio a la funcion ConnectHandler el argumento **Equipo guardo la conexion en la variable net_connect
